...
class _ProductPage4State extends State<ProductPage4> {
  int quantity = 1;
  String selectedFlavor = "Chocolate ao Leite";
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "Brownies irresistíveis, com textura macia por dentro, casquinha crocante por fora e muito chocolate nobre em cada pedaço.",
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                items: ["Chocolate ao Leite", "Chocolate meio amargo", "Ninho", "Nutella"]
                    .map((sabor) =>
