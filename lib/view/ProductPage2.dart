...
class _ProductPage2State extends State<ProductPage2> {
  int quantity = 1;
  String selectedFlavor = "Doce de Leite";
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "Nosso pão de mel é pura tentação: massa fofinha e aromática, feita com mel de verdade, recheada com doce, ganache ou Leite Ninho cremoso e coberta com uma generosa camada de chocolate nobre ao leite. Cada mordida é um abraço doce e acolhedor que desperta memórias e conquista corações.",
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                items: ["Doce de Leite", "Trufado", "Brigadeiro", "Leite Ninho"]
                    .map((sabor) =>
