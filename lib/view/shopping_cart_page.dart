...
class ShoppingCartPage extends StatefulWidget {
  ...
  ShoppingCartPage({
    super.key,
    required this.shoppingCartChangeNotifier,
...
class _ShoppingCartPageState extends State<ShoppingCartPage> {
  ...
  String? cupom;
  double descontoPercentual = 0.05;
  bool pagarNaEntrega = false;
        ...
        child: Column(
          children: [
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ProductCart(
                    ...
                    onIncrease: () => setState(() => shoppingCartNotifier.increaseQuantity(item.product.id)),
                    onDecrease: () => setState(() => shoppingCartNotifier.decreaseQuantity(item.product.id)),
                  );
                },
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Desconto ${(descontoPercentual * 100).toStringAsFixed(0)}%", style: const TextStyle(fontSize: 16)),
  ...
  children: [
    Checkbox(
      value: pagarNaEntrega,
      activeColor: Colors.pinkAccent,
      onChanged: (value) {
        setState(() {
          pagarNaEntrega = value ?? false;
        });
      },
    ),
    const Text(
